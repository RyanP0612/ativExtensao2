...
if(textController.text.isNotEmpty){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: signOut, icon: Icon(Icons.logout, color:Colors.grey[300],))
        ],
      ),
      body: Center(
        child: Column(
  ...
  child: StreamBuilder(
    ...
    stream: FirebaseFirestore.instance
        .collection("User Posts") // Acessa a coleção chamada "User Posts" no Firestore
        .orderBy("Timestamp", descending: false) // Ordena os documentos pelo campo "Timestamp" em ordem crescente
      ...
      if (snapshot.hasData) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return LeticiaLindaPost(message: post['Message'], user: post["UserEmail"]);
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  // textfield
                  Expanded(
                    child: MyTextField(controller: textController, hintText: "Escreva algo...", obscureText: false)
                     ),
